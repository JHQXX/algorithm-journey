...
public class PriorityQueue<E> implements Queue<E>{
    ...
    @SuppressWarnings("unchecked") //作用 忽视警告 如果使用deprecation(弃用) or unchecked(未检查)
    private void siftUpComparable(int k ,E x){
        ...
        while (k > 0){
            ...
            //这里不能写成 E e 是因为对于范型而言，是没有所谓的范型数组的概念的 Java 泛型擦除导致不能直接创建 E[]
            Object e = queue[parent];
            //如果当前位置元素 大于父节点元素 则推出循环
